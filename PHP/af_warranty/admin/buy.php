...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- DataTales Example -->
                    <form method="post" action="data/buy/export.php" id="submit_export_product" class="ml-4">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">ผู้ซื้อ</h6>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-sm" id="dataTable" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT * FROM register_buy ORDER BY id DESC";
    ...
    <script src="data/buy/buy.js"></script>
