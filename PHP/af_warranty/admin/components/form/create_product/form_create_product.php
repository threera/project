<form id="form_create_product" method="POST" class="row g-3 needs-validation" novalidate>
	...
	<hr>
	<div class="col-lg-4 col-sm-12">
		<label for="Village" class="form-label">เลขที่ (number)</label>
		<input type="text" class="form-control" name="Village" id="Village">
	</div>
	<div class="col-lg-8  col-sm-12">
		<label for="Number" class="form-label">หมู่ที่ หมู่บ้าน/อาคาร (Village/Building)</label>
		<input type="text" class="form-control" name="Number" id="Number">
	</div>
	<div class="col-lg-6 col-sm-12">
		<label for="Soi" class="form-label">ซอย (Soi)</label>
	...
	<div class="col-lg-3 col-sm-12">
		...
		<input name="amphure" id="amphure" type="text" class="form-control">
	</div>
	<div class="col-lg-3 col-sm-12">
