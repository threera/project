            ...
            <div class="modal-body">
                <form method="post" id="insert_form">
                    ...
                    <div class="col-lg-12 mb-2">
                        ...
                        <input type="text" class="form-control" name="amphure" id="amphure">
                    </div>
                    <div class="col-lg-12 mb-2">
                    ...
                    <div class="col-12 text-center mt-4 fo-button">
                        ...
                        <input type="submit" name="insert" id="insert" value="Insert" class="btn btn-warning" onClick="return confirm('คุณต้องการเเก้ไขข้อมูลใช่ไม?');"/>
                    </div>
                </form>
            </div>
