...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- DataTales Example -->
                    <form method="post" action="data/product/export.php" id="submit_export_product" class="ml-4" enctype="application/x-www-form-urlencoded;charset=UTF-8">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex justify-content-between">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-primary ml-4" name="export" disabled id="submit_export_product" onClick="return confirm('คุณต้องการ EXPORT ใชไม?');">
    ...
    <script src="data/product/product.js"></script>
