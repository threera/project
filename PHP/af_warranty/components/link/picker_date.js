function picker_date(element, option) {
    ...
    var render_cal_pic = function (element, month, year) {
        ...
        html += "<button class='btn btn-sm btn-danger clear_cal_btn' >";
        html += "<i class='fa fa-times' ></i>ออก & ล้างข้อมูลปฎิทิน";
        html += "</button>";
    ...
    $("[data-picker=" + ran_cal_id + "]").on("click", function () {
        ...
        cal.setAttribute(
            'style',
            'background-color: white;z-index: 2; position: absolute;width: 28%;',
        );
        ...
        $(left_btn).css("flex", "0.1");
        $(left_btn).html("<i class='bi bi-chevron-left'></i>");
        ...
        $(right_btn).css("flex", "0.1");
        $(right_btn).html("<i class='bi bi-chevron-right'></i>");
