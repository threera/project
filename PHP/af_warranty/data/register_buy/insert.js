$(document).ready(function () {
    $("#SerialNumber").keyup(function () {
        ...
        if ((SerialNumber.length == 17)) {
            $.ajax({
                type: "POST",
                url: "data/register_buy/fetchall.php",
                dataType: "json",
                data: {
                ...
                success: function (ret) {
                    if (ret['success']) {
                        ...
                        $('#register_buy_save').removeClass("disabled");
            ...
            $('#Product').val('');
            $('#Warranty').val('');
            $('#register_buy_save').addClass("disabled");
    ...
    $("#register_buy").submit(function (event) {
        ...
        if ($('#Purchase_date').val() != "" && $('#Customer_name').val() != ""
            ...
            $.ajax({
                type: "POST",
                url: "data/register_buy/insert.php",
                data: formData,
                dataType: 'json',
                success: function (ret) {
                    if (ret['success']) {
